...
CARBON_DURABLE_PATHS=(
	...
	"SCRIPTS-README.md"
	"STAGING-FORK-DEVIATIONS.md"
	"build-staging-hooks.md"
	"build-staging-hooks.sh"
	"install-server-carbon-dll.sh"
	"upgrade-staging.sh"
	"verify-staging-hooks.md"
	"verify-staging-hooks.sh"
	"staging-hookgen-expected-skips.json"
	"staging-hookgen-overlays/README.md"
	"staging-hookgen-overlays/staging.json"
	"src/Carbon.Components/Carbon.Common/src/Carbon/CorePlugin/Core.Hooks.Commands.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Community/src/Vending/OnMarketplaceTerminalPurchase.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Generator/src/Generation/Generator.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Generator/src/Generation/HookGenerationResult.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Generator/src/Generation/HookPolicies.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Generator/src/Generation/HookValidator.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Generator/src/Output/OutputWriter.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Generator/src/Program.cs"
	"src/Carbon.Hooks/Carbon.Hooks.Oxide/Carbon.Hooks.Oxide.csproj"
	"src/Carbon.Tools/Carbon.StagingHookVerifier/Carbon.StagingHookVerifier.csproj"
	"src/Carbon.Tools/Carbon.StagingHookVerifier/Program.cs"
	"src/Carbon.Tools/Carbon.StagingHookVerifier/StagingHookExpectations.cs"
	"tools/build/runners/build.cs"
